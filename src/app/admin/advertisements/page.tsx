...
const AdvertisementsPage = () => {
  ...
  const [imageInputMethod, setImageInputMethod] = useState<"url" | "upload">(
    "url"
  );
  ...
  return (
    <Box sx={{ display: "flex", minHeight: "100vh" }}>
          ...
          <Grid container spacing={3} sx={{ mb: 3 }}>
              ...
              <Card elevation={3}>
                <Box sx={{ p: 2, display: "flex", alignItems: "center" }}>
                  ...
                  <Box>
                    ...
                    >
                      {
                        advertisements.filter((ad) => isCurrentlyActive(ad))
                          .length
                      }
                    </Typography>
                    <Typography variant="body2" color="text.secondary">
            ...
            <Grid item xs={12} sm={6} md={3}>
              <Card elevation={3}>
                <Box sx={{ p: 2, display: "flex", alignItems: "center" }}>
                  <ImageIcon
                    sx={{ color: "error.main", mr: 2, fontSize: 32 }}
                  />
                  <Box>
                    <Typography
                      variant="h4"
      ...
      >
        ...
        <DialogContent>
          <Typography>
            Are you sure you want to delete advertisement "{adToDelete?.title}"?

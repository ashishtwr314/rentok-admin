...
const CategoriesPage = () => {
  ...
  const handleSaveCategory = async () => {
    try {
      ...
      try {
        ...
        setSnackbar({ open: true, message: 'Error uploading image to ImageKit', severity: 'error' })
  ...
  const toggleCategoryStatus = async (category: Category) => {
    try {
      ...
      setSnackbar({ open: true, message: 'Error updating category status', severity: 'error' })
    }
  }
          ...
          <Box sx={{ display: 'flex', gap: 3, mb: 3, flexWrap: 'wrap' }}>
            ...
            <Box sx={{ minWidth: 200 }}>
              <Card sx={{ p: 2, textAlign: 'center' }}>
                <Typography variant="h6" sx={{ color: THEME_COLORS.rentPrimary, fontWeight: 'bold' }}>
                  ...
                  {loading ? (
                    ...
                    paginatedCategories.map((category) => (
                      <TableRow key={category.category_id} hover>
                        ...
                        <TableCell>
                          <Box sx={{ display: 'flex', alignItems: 'center' }}>
                            <DragHandleIcon sx={{ fontSize: 16, mr: 1, color: 'text.secondary' }} />
